...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/cftpsa_enmp_mca/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov8n-transformerx3-mca.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='FLIR_aligned.yaml', help='data.yaml path')
